  ...
  return (
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2 text-right">
          <label className="text-[10px] font-bold text-gray-400 px-1">المكونات (افصل بينها بفاصلة ،)</label>
          <div className="relative">
        ...
        <div className="space-y-2 text-right">
          ...
          <textarea name="description" defaultValue={editingItem?.description} placeholder="اكتب وصفاً جذاباً للمنتج..." className="w-full min-h-[120px] p-4 rounded-xl bg-gray-50 border-none font-medium text-right text-sm outline-none focus:ring-1 focus:ring-primary/20 transition-all" />
        </div>
      </div>
    </div>
  )
