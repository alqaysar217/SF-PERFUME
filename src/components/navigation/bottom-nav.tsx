...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-xl border-t border-gray-100 px-4 pb-2 pt-2 z-50 rounded-t-3xl shadow-[0_-8px_30px_rgba(0,0,0,0.04)] md:max-w-md md:mx-auto">
          ...
          return (
            ...
            >
              <div className={cn(
                ...
                isActive ? "bg-primary/10 scale-105" : "group-hover:bg-gray-50"
              )}>
                <Icon 
              ...
              <span className={cn(
                "text-[7px] font-black uppercase tracking-widest transition-opacity",
