...
export const PRODUCTS: Product[] = [
  {
    ...
    size: '100 مل',
    category: 'men',
    description: 'عطر رجالي مركز جداً يجمع بين التوابل واللافندر والأخشاب الغنية. يعتبر من أكثر العطور مبيعاً لثباته العالي ورائحته الجذابة.',
  ...
  },
  {
    ...
    size: '90 مل',
    category: 'women',
    description: 'عطر نسائي يجسد الحرية والأنوثة الطاغية بمزيج من اللافندر والياسمين والفانيليا الدافئة.',
  ...
  },
  {
    ...
    size: '100 مل',
    category: 'men',
    description: 'عطر جلدي فاخر يعطي إحساساً بالعمق والغموض، مستوحى من الصحراء والجلود الفاخرة.',
  ...
  {
    id: '4',
    name: 'ساعة رولكس دايتونا',
    brand: 'رولكس',
    price: 45000,
    image: 'https://picsum.photos/seed/watch1/600/800',
    size: '40 ملم',
    category: 'watches',
    description: 'ساعة فاخرة من الفولاذ والذهب، تصميم كلاسيكي لا يتقادم، تعكس الذوق الرفيع والتميز.',
    ingredients: 'فولاذ 904L، ذهب 18 قيراط، زجاج ياقوتي مقاوم للخدش.',
    projection: 'N/A',
  ...
  },
  {
    ...
    size: '75 مل',
    category: 'women',
    description: 'باقة زهرية متقنة تليق بالمرأة العصرية والفاخرة، تعطي شعوراً بالرقي والنعومة.',
  ...
  },
  {
    ...
    brand: 'شانيل',
    price: 520,
    image: 'https://picsum.photos/seed/perfume6/600/800',
    size: '100 مل',
    category: 'men',
    description: 'عطر أروما خشبي كلاسيكي يجمع بين الانتعاش والجاذبية، مناسب للاستخدام اليومي والمناسبات.',
    ingredients: 'حمضيات، صندل، أرز، بخور، عنبر.',
    projection: 'متوسط',
    longevity: '7-9 ساعات'
  }
];
